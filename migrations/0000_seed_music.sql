...
--> statement-breakpoint
CREATE TABLE "_z_fans" (
	"id" text PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	"email" text NOT NULL,
	"created_at" timestamp NOT NULL,
	CONSTRAINT "_z_fans_email_unique" UNIQUE("email")
);
--> statement-breakpoint
CREATE TABLE "_z_favorites" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "_z_albums" ADD CONSTRAINT "_z_albums_artist_id__z_artists_id_fk" FOREIGN KEY ("artist_id") REFERENCES "public"."_z_artists"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "_z_favorites" ADD CONSTRAINT "_z_favorites_fan_id__z_fans_id_fk" FOREIGN KEY ("fan_id") REFERENCES "public"."_z_fans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "_z_favorites" ADD CONSTRAINT "_z_favorites_album_id__z_albums_id_fk" FOREIGN KEY ("album_id") REFERENCES "public"."_z_albums"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

-- Seed data for music database

-- Add some fans
INSERT INTO "_z_fans" ("id", "name", "email", "created_at") VALUES
...
-- Add some artists
INSERT INTO "_z_artists" ("id", "name", "genre", "bio", "created_at") VALUES
...
-- Add some albums
INSERT INTO "_z_albums" ("id", "title", "artist_id", "release_year", "cover_art_url", "created_at") VALUES
...
-- Add some favorites
INSERT INTO "_z_favorites" ("id", "fan_id", "album_id", "created_at") VALUES
